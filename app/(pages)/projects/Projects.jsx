...
const Projects = () => {
  return (
    <div className='flex pt-[160px] w-full h-[200vh] flex-col gap-[70px]'>
        ...
        <div className=' pb-8 w-full flex flex-col gap-7 '>
            
            <h1 className='text-[min(11.5vw,200px)] col-span-1 leading-[.9]  text-[#11120d]   font-DMSerifDisplay '> Selected Projects</h1>
